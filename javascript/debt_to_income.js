// Animated Collapsible - Tips Section id="headlines" ------------------------/
var coll = document.getElementById("headlines").getElementsByClassName("collapsible");
for (var i = 0; i < coll.length; i++) {
    coll[i].addEventListener("click", function () {
        // Hide all elements with class content
        var contents = document.getElementById("headlines").getElementsByClassName("content");
