...
require_once('RESO\config.php');
require_once('RESO\init.php');
...
// Authorize user
$auth_code = RESO\OpenIDConnect::authorize($auth_username, $auth_password, 'https://openid.reso.org/', 'ODataApi');
// Get access token
